...
void CodecNode::Yuv422ToRGBA8888(std::shared_ptr<IBuffer>& buffer)
{
    ...
    // avpicture_fill((AVPicture *)pFrameRGBA, (uint8_t *)buffer->GetVirAddress(), AV_PIX_FMT_RGBA,previewWidth_, previewHeight_);
    // struct SwsContext* imgCtx = sws_getContext(previewWidth_, previewHeight_, AV_PIX_FMT_YUYV422, previewWidth_,previewHeight_, AV_PIX_FMT_RGBA, SWS_BILINEAR, 0, 0, 0);    
    //AV_PIX_FMT_BGRA
    avpicture_fill((AVPicture *)pFrameRGBA, (uint8_t *)buffer->GetVirAddress(), AV_PIX_FMT_BGRA,previewWidth_, previewHeight_);
    struct SwsContext* imgCtx = sws_getContext(previewWidth_, previewHeight_, AV_PIX_FMT_YUYV422, previewWidth_,previewHeight_, AV_PIX_FMT_BGRA, SWS_BILINEAR, 0, 0, 0);
